...
for(let someNumber = 0; someNumber <= 100; someNumber++) {
  if(someNumber < 30 == 0)
  console.log(someNumber + ' ' + 'We got a big one!')
    else if(someNumber >= 30 == 0)
    console.log(someNumber + ' ' + 'Thats a small number!')
    else if(someNumber >= 61 == 0)
...
function prompt11() {
  let median= nums.sort();
  // YOUR CODE HERE
  let midIndex = Math.floor(nums.length/2);
  console.log(median);
  console.log(median[midIndex]);
}
// COMMENT IN THE BELOW LINE OF CODE TO TEST YOUR OUTPUT IN THE BROWSER!
 prompt11();
