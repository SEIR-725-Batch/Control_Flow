...
//  someNumber is a any integer between 0 and 100 exclusive
...
// var someNumber = Math.round(Math.random()*100);
...
//     console.log(starWars[i] + " is at index " + i);
//   }
// }
 ...
 * The median number is the middle number in a SORTED list of numbers. 
 * Think through the steps you'll need to take to determine this number with code!
 *
...
//global variable numsArray
function prompt11(numsArray) {
  ...
  if(median.length % 2 === 0){
    let upperBound = nums[array.length/2]
    let lowerBound = nums[(array.legnth/2) -1 ]
    return median = (lowerBound + upperBound)/2;
  }else{
    return nums[Math.floor(arrayLength/2)];
  }
}
...
//     let innerArrays = nestedArrays[i];
    
//     for(j=0; j<innerArrays.length;j++){
//     console.log(innerArrays[j])
//     }
//   }
// }
