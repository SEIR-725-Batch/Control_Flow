...
function prompt11() {
  let median;
  // YOUR CODE HERE
  nums.sort(); //got ahead of myself and almost wrote a loop that manually sorted the array
  let medianIndex = Math.floor(nums.length/2)+1; //bc nums.length is odd
