...
function prompt8() {
  ...
  } else if (someNumber > 60) {console.log("We got a big one!")
  };
}
...
function prompt11() {
  ...
  length = nums.length; //25
  let median = sortedArray[13]
  console.log(median)
}
...
/// not sure I did what the question was asking.. had trouble understanding what needed to 
// be printed in the inner loop, but this way returns numbers 0-20
