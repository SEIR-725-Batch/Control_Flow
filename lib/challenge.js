...
function prompt7() {
  ...
  for (let s=0; s>=0 && s<=100; s++)
  if (s % 5 ===0) {
    let output = `I found a ${s}. High five!`
    console.log(output)
  }
}
...
var someNumber =(Math.random(0,100)) ;
