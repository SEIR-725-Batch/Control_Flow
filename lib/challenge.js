 ...
 */
function prompt7() { for (let i = 0; i <= 20; i++) {
let multipleFive = (i*5);
console.log("I found a " +multipleFive+ ". High five!")}
}
...
var someNumber= Math.floor(Math.random()*101);

function prompt8() {
  if (someNumber<30){
    console.log("That's a small number! " + someNumber);
  }
  else if (someNumber<=60){
    console.log("That number is medium sized. "+ someNumber);
  }
  else{
    console.log("We got a big one! " + someNumber)
  }
}
